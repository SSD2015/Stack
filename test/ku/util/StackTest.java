...
public class StackTest {
	...
	public void testCapacity() {
		...
		stack = StackFactory.makeStack(100);
	...
	public void testStackSize() {
		int cap = 90;
		stack = StackFactory.makeStack(cap);
		for(int k=1; k<=10; k++) {
	...
	public void testStackSizeOne() {
		...
		Stack<String> stack = StackFactory.makeStack(capacity);
	...
	public void testPushAndPop() {
		...
		stack = StackFactory.makeStack( ITEMS.length );
